    ...
    jQuery(document).ready(function(){
        ...
        */
        ...
        $('.ltn__slide-one-active').slick({
            ...
            slidesToShow: 1,
            slidesToScroll: 1,
            prevArrow: '<a class="slick-prev1"><i class="fas fa-arrow-left1" alt="Arrow Icon"></i></a>',
            nextArrow: '<a class="slick-next1"><i class="fas fa-arrow-right1" alt="Arrow Icon"></i></a>',
            responsive: [
                {
                    breakpoint: 1200,
                    settings: {
